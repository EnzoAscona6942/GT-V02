<div class="flex flex-col gap-6">
    <x-auth-header :title="__('Ingresar a tu cuenta')" :description="__('Ingresa tu email y contrasela debajo')" />
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <flux:input
            ...
            autofocus
            autocomplete="email"
            placeholder="tuturrito@example.com"
        />
